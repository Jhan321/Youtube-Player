...
namespace Unity.Coding.Utils
{
    ...
    static class NativeUnix
    {
        ...
        static class Mac
        {
            ...
            public static extern int stat_intel(string file, ref STAT64 buf);

            [DllImport("libc", EntryPoint = "stat", SetLastError = true)]
            public static extern int stat_arm(string file, ref STAT64 buf);
        }
        ...
        public static int GetFileMode([NotNull] string filePath, out UnixFilePermissions permission)
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
            {
                ...
                if (RuntimeInformation.ProcessArchitecture == Architecture.Arm64)
                    ret = Mac.stat_arm(filePath, ref stat);
                else
                    ret = Mac.stat_intel(filePath, ref stat);
                if (ret == 0)
