...
namespace YoutubePlayer
{
    public class PlayV
    {
        ...
        {
            GameObject.Find("YouTubeCanvas/YouTubeSearch").GetComponent<YouTubeSearch>().YoutubePlayer.GetComponent<YoutubePlayer>().youtubeUrl = URL;
            GameObject.Find("YouTubeCanvas/YouTubeSearch").GetComponent<YouTubeSearch>().YoutubePlayer.GetComponent<VideoPlayer>().Stop();
            GameObject.Find("YouTubeCanvas/YouTubeSearch").GetComponent<YouTubeSearch>().YoutubePlayer.GetComponent<VideoPlayer>().url = null;
            GameObject.Find("YouTubeCanvas/YouTubeSearch").GetComponent<YouTubeSearch>().YoutubePlayer.SetActive(true);
            GameObject.Find("YouTubeCanvas").gameObject.SetActive(false);
        }
    }
}
